...
<!--   -->
        ...
        <div class="container" id="infoDisp">
                <div class="row">
                    <div class="col">
                        <img src="https://www.biography.com/.image/t_share/MTQzMDAyNzYyNTU1MTcyMDQ1/edvard-munch-self-portraitjpg.jpg" style="width:600px;">
                    </div>
                    <div class="col">
                        <p>Edvard Munch</p>
                        <p>DOB / Death: December 12, 1863/January 23, 1944</p>
                        <p>Place of Living: Oslo, Norway</p>
                        <p>Genre: Pre-Modern</p>
                        <p>Famous Works: The Scream</p>
                    </div>
                </div>
            </div>
        <!-- /Main Area -->
