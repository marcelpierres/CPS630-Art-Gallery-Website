...
<!--   -->
        ...
        <div class="container" id="infoDisp">
                <div class="row">
                    <div class="col">
                        <img src="https://pixel.nymag.com/imgs/daily/vulture/2017/11/14/14-the-room-tommy-wiseau.w710.h473.2x.jpg" style="width:600px;">
                    </div>
                    <div class="col">
                        <p>Grant Wood</p>
                        <p>DOB/Death: February 13, 1891/February 12, 1942</p>
                        <p>Place of Living: Iowa City, Iowa, United States</p>
                        <p>Genre: Gothic</p>
                        <p>Famous Works: American Gothic</p>
                    </div>
                </div>
            </div>
        <!-- /Main Area -->
