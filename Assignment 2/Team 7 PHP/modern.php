...
<!--   -->
        ...
        <div class="container" id="infoDisp">
                <div class="row">
                    <div class="col">
                        <img src="https://flavorwire.files.wordpress.com/2011/02/10-roy-lichtenstein-kiss-v.jpg?w=1920" style="width:600px;">
                    </div>
                    <div class="col">
                        <p>Date of Creation: December 10th 1977</p>
                        <p>Painting Colors: Dots</p>
                        <p>Dimensions: 2000x1400</p>
                        <p>Location: United States</p>
                        <p>Artist: Roy Lichtenstein</p>
                        <p>Price: $2 Million USD</p>
                        <p>Genre: Modern</p>
                    </div>
                </div>
            </div>
