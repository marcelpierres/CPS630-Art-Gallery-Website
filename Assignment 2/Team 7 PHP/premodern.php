...
<!--   -->
        ...
        <div class="container" id="infoDisp">
            <div class="row">
                <div class="col">
                    <img src="https://cms-assets.tutsplus.com/uploads/users/346/posts/29963/preview_image/arthistmodpre.jpg" style="width:600px;">
                </div>
                <div class="col">
                    <p>Date of Creation: December 10th 1800</p>
                    <p>Painting Colors: Oil</p>
                    <p>Dimensions: 2000x1400</p>
                    <p>Location: Italy</p>
                    <p>Artist: Edvard Munch</p>
                    <p>Price: $30 Million USD</p>
                    <p>Genre: Pre-Modern</p>
                </div>
            </div>
        </div>
