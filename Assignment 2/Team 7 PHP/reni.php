...
<!--   -->
        ...
        <div class="container" id="infoDisp">
                <div class="row">
                    <div class="col">
                        <img src="https://s3.amazonaws.com/res.milq.com/img/posts/deeply-weird-renaissance-art_2.jpg" style="width:600px;">
                    </div>
                    <div class="col">
                        <p>Date of Creation: December 10th 1701</p>
                        <p>Painting Colors: I don't even know</p>
                        <p>Dimensions: 2000x1400</p>
                        <p>Location: Germany</p>
                        <p>Artist: High Artist</p>
                        <p>Price: $10 Million USD</p>
                        <p>Genre: Renissance</p>
                    </div>
                </div>
            </div>
